...
int main(int argc, char *argv[])
{
	...
	shared_ptr<dynamic::modeling::model> Aircraft1=dynamic::translate::make_dynamic_atomic_model<Aircraft, TIME,int,int,int,int,int>("Aircraft1",1,2,1,300,4);
	
	shared_ptr<dynamic::modeling::model> Aircraft2=dynamic::translate::make_dynamic_atomic_model<Aircraft, TIME,int,int,int,int,int>("Aircraft2",2,2,1,300,4);
	
	shared_ptr<dynamic::modeling::model> Aircraft3=dynamic::translate::make_dynamic_atomic_model<Aircraft, TIME,int,int,int,int,int>("Aircraft3",3,2,1,300,4);
	...
	dynamic::modeling::Models submodels_Locations = {Trenton,Alert,HallBeach,CambridgeBay,Inuvik};
	...
	dynamic::modeling::Models submodels_Aircraft = {Aircraft1,Aircraft2,Aircraft3};
