...
int main(int argc, char *argv[])
{
	...
	shared_ptr<dynamic::modeling::model> Yellowknife=dynamic::translate::make_dynamic_atomic_model<Location, TIME,int,string,double,double>("Yellowknife",6,"Yellowknife",62.453972,-114.371788);
