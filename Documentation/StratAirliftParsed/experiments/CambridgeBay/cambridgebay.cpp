...
int main(int argc, char *argv[])
{
	...
	shared_ptr<dynamic::modeling::model> CambridgeBay=dynamic::translate::make_dynamic_atomic_model<Location, TIME,int,string,double,double>("CambridgeBay",6,"Cambridge Bay",69.120979,-105.056259);
	...
	shared_ptr<dynamic::modeling::model> Yellowknife=dynamic::translate::make_dynamic_atomic_model<Location, TIME,int,string,double,double>("Yellowknife",4,"Yellowknife",62.453972,-114.371788);
	...
	shared_ptr<dynamic::modeling::model> Aircraft2=dynamic::translate::make_dynamic_atomic_model<Aircraft, TIME,int,int,int,int,int>("Aircraft2",2,2,6,490,16);
	...
	dynamic::modeling::Models submodels_Locations = {Trenton,Alert,HallBeach,CambridgeBay,Inuvik,Yellowknife};
	...
	dynamic::modeling::EICs eics_Locations = {
		...
		dynamic::translate::make_EIC<LOC_InputLoads, Locations_defs::inLoads>("Yellowknife"),
		dynamic::translate::make_EIC<LOC_InputACStatus, Locations_defs::inACStatus>("Yellowknife"),
		dynamic::translate::make_EIC<LOC_InputPallets, Locations_defs::inPallets>("Yellowknife"),
		dynamic::translate::make_EIC<LOC_InputLocInfo, Locations_defs::inLocInfo>("Yellowknife")
	};
	...
	dynamic::modeling::EOCs eocs_Locations = {
		...
		dynamic::translate::make_EOC<Locations_defs::outLoads, LOC_outLoads>("Yellowknife"),
		dynamic::translate::make_EOC<Locations_defs::outPallets, LOC_outPallets>("Yellowknife")
	};
